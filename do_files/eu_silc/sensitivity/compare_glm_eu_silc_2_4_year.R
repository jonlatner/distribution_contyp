...
df_eu_silc_clean_xc <- readRDS(file = paste0(data_files, "03_df_eu_silc_clean_xc.rds"))
df_eu_silc_clean_panel <- readRDS(file = paste0(data_files, "03_df_eu_silc_clean_panel.rds"))
